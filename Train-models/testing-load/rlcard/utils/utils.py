...
# to get the list of payoffs, rather than average
def modifiedTournament(env, num):
    ...
    avg_payoffs = [sum(p) / len(p) for p in payoffs]

    return avg_payoffs, payoffs  # returning both
