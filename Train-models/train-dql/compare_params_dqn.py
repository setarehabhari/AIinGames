...
# Log file path
log_file_path = 'eval_dqn_params_4_22_1.txt'
...
for run_dir in os.listdir(base_dir):
    if run_dir.startswith("eps"):
        #print(run_dir)
        run_path = os.path.join(base_dir, run_dir)
        run_id = run_dir
        print(run_id)
        csv_path = os.path.join(run_path, f"performance_{run_id}.csv")
        log_path = os.path.join(run_path, f"log_{run_id}.txt")
...
with open(log_file_path, 'w') as log_file:
    ...
    for param, param_data in hyperparameter_data.items():
        ...
        for param_value, metrics in param_data.items():
            ...
            plot_file_path = os.path.join(".", f"./dqn_4_22_1/{param}_vs_avg_reward_{param_value}.png")
        ...
        combined_plot_file_path = os.path.join(".", f"./dqn_4_22_1/{param}_vs_avg_reward_all_values.png")
